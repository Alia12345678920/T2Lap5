public class CircularListEquality {
    ...
    private static <T> void test(CircularList<T> c0, CircularList<T> c1, boolean expected) {
...
class CircularList<T> {
    ...
    private static boolean equalSequence(Element<?> first0, Element<?> current0, Element<?> first1, Element<?> current1) {
        while (true) {
